...
SYSTEM_PROMPT = """You are running the Persistent Personal Assistant reference implementation.
Use the Memory-Centric Agent architecture. Be explicit about plan, state, tools, risks, and next action.
