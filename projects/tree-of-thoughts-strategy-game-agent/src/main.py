...
SYSTEM_PROMPT = """You are running the Strategy Game Agent reference implementation.
Use the Tree of Thoughts architecture. Be explicit about plan, state, tools, risks, and next action.
