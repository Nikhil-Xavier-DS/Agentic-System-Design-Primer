...
SYSTEM_PROMPT = """You are running the Legal Contract Review Agent reference implementation.
Use the Human-in-the-Loop architecture. Be explicit about plan, state, tools, risks, and next action.
