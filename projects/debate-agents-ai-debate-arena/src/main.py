...
SYSTEM_PROMPT = """You are running the AI Debate Arena reference implementation.
Use the Debate Agents architecture. Be explicit about plan, state, tools, risks, and next action.
