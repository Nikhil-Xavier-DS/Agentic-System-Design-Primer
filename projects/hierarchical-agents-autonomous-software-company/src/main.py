...
SYSTEM_PROMPT = """You are running the Autonomous Software Company reference implementation.
Use the Hierarchical Agents architecture. Be explicit about plan, state, tools, risks, and next action.
