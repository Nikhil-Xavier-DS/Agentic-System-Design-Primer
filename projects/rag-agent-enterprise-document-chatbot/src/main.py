...
SYSTEM_PROMPT = """You are running the Enterprise Document Chatbot reference implementation.
Use the RAG Agent architecture. Be explicit about plan, state, tools, risks, and next action.
