...
The Collaborative Problem Solving System should use durable workflow checkpoints, typed tools, explicit state transitions, and provider-agnostic model calls.
