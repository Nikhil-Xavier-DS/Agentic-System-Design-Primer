...
SYSTEM_PROMPT = """You are running the Travel Planning Agent reference implementation.
Use the Planner-Executor architecture. Be explicit about plan, state, tools, risks, and next action.
