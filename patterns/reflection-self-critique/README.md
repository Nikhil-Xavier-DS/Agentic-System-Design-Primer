...
Critique, revise, and verify outputs before finalization.
...
```mermaid
flowchart TB
    Input[Task Input] --> Agent[Reflection / Self-Critique]
...
See `projects/reflection-self-critique-self-correcting-coding-agent`.
