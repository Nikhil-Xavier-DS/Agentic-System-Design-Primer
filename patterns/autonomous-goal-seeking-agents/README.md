...
Continuously plan, execute, observe, and replan toward goals.
...
```mermaid
flowchart TB
    Input[Task Input] --> Agent[Autonomous Goal-Seeking Agents]
...
See `projects/autonomous-goal-seeking-agents-autonomous-research-agent`.
