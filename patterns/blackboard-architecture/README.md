...
Let independent specialists contribute to shared working memory.
...
```mermaid
flowchart TB
    Input[Task Input] --> Agent[Blackboard Architecture]
...
See `projects/blackboard-architecture-collaborative-problem-solving-system`.
