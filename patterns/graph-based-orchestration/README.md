...
Represent agent workflows as explicit state graphs.
...
```mermaid
flowchart TB
    Input[Task Input] --> Agent[Graph-Based Orchestration]
...
See `projects/graph-based-orchestration-enterprise-workflow-engine`.
